...
def google_signin():
    ...
    password.send_keys("csesvcn575#@!")  # replace the password
    driver.find_element_by_xpath('//*[@id="passwordNext"]/div/button').click()
    time.sleep(10)


def mic_off():
    driver.find_element_by_xpath('//*[@id="yDmH0d"]/c-wiz/div/div/div[9]/div[3]/div/div/div[4]/div/div/div[1]/div['
                                 '1]/div/div[4]/div[1]/div/div/div/span/span/div/div[1]/div').click()


def camera_off():
    driver.find_element_by_xpath(
        '//*[@id="yDmH0d"]/c-wiz/div/div/div[9]/div[3]/div/div/div[4]/div/div/div[1]/div[1]/div/div[4]/div[2]/div/div/span/span/div/div').click()


def meet_join():
    meet_id = driver.find_element_by_xpath('//*[@id="i3"]')
    meet_id.send_keys("meeting_id")
    driver.find_element_by_xpath(
        '//*[@id="yDmH0d"]/c-wiz/div/div[2]/div/div[1]/div[3]/div/div[2]/div[2]/button/span').click()
    time.sleep(5)
    mic_off()
    time.sleep(1)
    camera_off()
...
if __name__ == '__main__':
    ...
    people = driver.find_element_by_xpath(
        '//*[@id="ow3"]/div[1]/div/div[9]/div[3]/div[10]/div[3]/div[2]/div/div/div[2]/div/div')
    while int(people.text) != 0:
        if int(people.text) < 15:
            driver.find_element_by_xpath(
                '//*[@id="ow3"]/div[1]/div/div[9]/div[3]/div[10]/div[2]/div/div[6]/span/button').click()
            break
        else:
            time.sleep(10)
